...
\newcommand{\dcdepart}{Fakultät} % Fakulttsangabe
\newcommand{\dcprof}{Professur} % Angabe der Professur

\newcommand{\dcpruefer}{Tom Uhlmann}% Prfer der Arbeit
\newcommand{\dcadvisor}{Tom Uhlmann}% Betreuer der Arbeit
